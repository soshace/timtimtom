...
function flatsome_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Cart currency', 'flatsome' ),
        'id'            => 'cart-currency',
...
//alex custom code
function alexs_currency_symbol( $currency_symbol, $currency ) {
...
add_filter('woocommerce_currency_symbol', 'alexs_currency_symbol', 30, 2);
