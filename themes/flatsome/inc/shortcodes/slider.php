...
<div id="slider_<?php echo $sliderrandomid ?>" class="iosSlider default" style="<?php if($height) echo 'min-height:'.$height.'; height:'.$height .';max-width:100%;' ?>">
    ...
    $(window).load(function(){
     ...
     function slideResize(args) {
        ...
        setTimeout(function(){
              ...
              $(args.sliderContainerObject).css('min-height',slide_height);
              $(args.sliderContainerObject).css('height','auto');
              $(args.sliderContainerObject).css('max-width','100%');
        },300);
