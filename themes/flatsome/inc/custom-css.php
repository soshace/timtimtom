...
<style type="text/css">
   ...
   <?php }?>
	...
	/* BUBBLE COLORS */
	.callout-new-bg{background-color:<?php echo $flatsome_opt['color_new_bubble'];?>!important;}
	.callout.style3 .callout-new-bg{background-color: none!important;border-color: <?php echo $flatsome_opt['color_new_bubble'];?>!important}
